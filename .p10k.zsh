# Generated by Powerlevel10k configuration wizard on 2020-02-25 at 00:10 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=400
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least
  # COLUMNS * POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT * 0.01 columns for typing commands.
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT=500
  ...
  #
     typeset -g POWERLEVEL9K_DIR_WORK_FOREGROUND=1
     typeset -g POWERLEVEL9K_DIR_WORK_SHORTENED_FOREGROUND=1
     typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND=1
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=()
  ...
  function my_git_formatter() {
    ...
    # If local branch name or tag is at most 100 characters long, show it in full.
    # Otherwise show the first 12 … the last 12.
    (( $#where > 100 )) && where[13,-13]="…"
